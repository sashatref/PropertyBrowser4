...
class PropertyBrowser_P;
class DefaultPropertyItem;

class PROPERTYBROWSER3_EXPORT PropertyBrowser : public QWidget, public ISaveWidget
{
    PropertyBrowser_P *const d;
    Ui::PropertyBrowser *ui;

    friend class PropertyBrowser_P;
