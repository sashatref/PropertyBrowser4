...
PropertyBrowser_P::~PropertyBrowser_P()
{
    delete m_delegate;
    delete m_undoStack;
}

void PropertyBrowser_P::updateStyle()
{
...
void PropertyBrowser_P::updateLanguage()
{
    q->ui->retranslateUi(q);
    q->translate();
}

void PropertyBrowser_P::saveExpandedState()
{
...
void PropertyBrowser_P::loadExpandedState()
{
    QList<QTreeWidgetItem*> array = TreeWidgetUtils::getAllSubItems(q->ui->treeWidget->topLevelItem(0));
...
void PropertyBrowser_P::clearWarnings()
{
...
void PropertyBrowser_P::updateProperties(const QVariantList &_valueList,
                                         const QStringList &_properties,
                                         bool sendNotify)
{
...
void PropertyBrowser_P::createProperties(const QVariantList &_valueList)
{
...
//    QMap<QObject*, QStringList> map;
    ...
    for(const QString &it : properties)
    {
        ...
        connect(addedItem,
                ...
                this,
                &PropertyBrowser_P::valueChanged);
        connect(addedItem,
                &AbstractPropertyItem::valueChanged2,
                this,
                &PropertyBrowser_P::valueChanged2);
    }

    updateProperties(_valueList, properties);
}

void PropertyBrowser_P::initListWidget(const QVariantList &_valueList)
{
    using namespace PropertyBrowser3Qt;
...
void PropertyBrowser_P::initVariantList(const QVariantList &_valueList)
{
    using namespace PropertyBrowser3Qt;
...
void PropertyBrowser_P::on_actionDefault_triggered()
{
...
void PropertyBrowser_P::on_actionCopy_triggered()
{
    QList<QTreeWidgetItem*> items = q->ui->treeWidget->selectedItems();
...
void PropertyBrowser_P::on_actionPaste_triggered()
{
...
void PropertyBrowser_P::on_actionRedo_clicked()
{
    m_undoStack->redo();
}

void PropertyBrowser_P::on_actionUndo_clicked()
{
    m_undoStack->undo();
}

void PropertyBrowser_P::on_actionShowUndoRedoList_clicked(bool isChecked)
{
    q->ui->undoView->setVisible(isChecked);
}

void PropertyBrowser_P::addButtonClicked()
{
    QVariant newObj;
...
void PropertyBrowser_P::removeButtonClicked()
{
...
void PropertyBrowser_P::customContextMenu(const QPoint &_point)
{
    QMenu menu;
...
void PropertyBrowser_P::treeWidgetItemClicked(QTreeWidgetItem *_currentItem,
                                              QTreeWidgetItem * /*_prevItem*/)
{
...
void PropertyBrowser_P::listWidgetItemSelectionChanged()
{
    QVariantList list;
...
void PropertyBrowser_P::valueChanged(const QString &_propertyName, const QVariant &_value)
{
...
void PropertyBrowser_P::valueChanged2(const QString &_propertyName,
...
void PropertyBrowser_P::onSearchTextChanged(const QString &_text)
{
...
void PropertyBrowser_P::onCofigButtonClicked()
{
    using namespace PropertyBrowser3Qt;
...
void PropertyBrowser_P::applyConf()
{
...
AbstractPropertyItem *PropertyBrowser_P::getPropertyItem(QVariant &_var)
{
    QObject *obj = _var.value<QObject*>();
    return dynamic_cast<AbstractPropertyItem*>(obj);
}

bool PropertyBrowser_P::eventFilter(QObject *watched, QEvent *event)
{
